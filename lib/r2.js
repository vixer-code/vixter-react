 ...
 */
async function generateUploadSignedUrl(key, contentType, expiresIn = 3600) {
 ...
 */
async function generateDownloadSignedUrl(key, expiresIn = 3600) {
 ...
 */
async function generateWatermarkUrl(originalKey, userId, expiresIn = 3600) {
 ...
 */
function generateMediaKey(userId, type, itemId, originalName) {
