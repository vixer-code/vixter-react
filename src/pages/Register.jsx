    ...
    <div className="auth-page">
      <div className="auth-container">
        <div className="auth-steps">
          <div className={`step ${currentStep >= 1 ? 'active' : ''}`} data-step="1">1. Conta</div>
          <div className={`step ${currentStep >= 2 ? 'active' : ''}`} data-step="2">2. Perfil</div>
          <div className={`step ${currentStep >= 3 ? 'active' : ''}`} data-step="3">3. Preferências</div>
          <div className={`step ${currentStep >= 4 ? 'active' : ''}`} data-step="4">4. Verificação</div>
        </div>
