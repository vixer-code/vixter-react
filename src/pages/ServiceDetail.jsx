...
const ServiceDetail = () => {
  ...
  const calculateVpTotal = () => {
    ...
    return Math.round(vcTotal / 0.67); // Convert VC to VP (1 VC = 0.67 VP)
  };
          ...
          <div className="service-header">
            ...
            <div className="service-price">
              {service.discount && service.discount > 0 ? (
                <>
                  <span className="price-original">{formatVP(Math.round(service.price / 0.67))}</span>
                  <span className="price-amount">{formatVP(calculateVpTotal())}</span>
                  <span className="discount-badge">-{service.discount}%</span>
                </>
              ) : (
                <span className="price-amount">{formatVP(Math.round(service.price / 0.67))}</span>
              )}
            ...
            <div className="purchase-summary">
              ...
              <div className="price-breakdown">
                <div className="price-item">
                  ...
                  <span>{formatVP(Math.round(service.price / 0.67))}</span>
                </div>
                {service.discount && service.discount > 0 && (
                  <div className="price-item discount-item">
                    <span>Desconto ({service.discount}%)</span>
                    <span>-{formatVP(Math.round(service.price / 0.67) - calculateVpTotal())}</span>
                  </div>
                )}
