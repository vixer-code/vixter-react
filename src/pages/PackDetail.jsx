...
const PackDetail = () => {
  ...
  const calculateVpTotal = () => {
    ...
    return Math.round(discountedPrice / 0.67); // Convert VC to VP (1 VC = 0.67 VP)
  };
            ...
            <div className="purchase-summary">
              ...
              <div className="price-breakdown">
                <div className="price-item">
                  ...
                  <span>{formatVP(Math.round(pack.price / 0.67))}</span>
                </div>
                {pack.discount && pack.discount > 0 && (
                  <div className="price-item discount-item">
                    <span>Desconto ({pack.discount}%)</span>
                    <span>-{formatVP(Math.round(pack.price / 0.67) - calculateVpTotal())}</span>
                  </div>
                )}
