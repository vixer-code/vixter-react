                ...
                >
                  ...
                  <div className="service-info">
                    ...
                    <div className="service-price">
                      <div className="price-original">VP {(service.price != null ? Math.round(service.price / 0.67).toFixed(2) : '0.00')}</div>
                      <div className="price-discounted">
                        VP {(() => {
                          const basePrice = service.price || 0;
                          const discount = service.discount || 0;
                          const discountedPrice = discount > 0 ? basePrice * (1 - discount / 100) : basePrice;
                          return Math.round(discountedPrice / 0.67).toFixed(2);
                        })()}
                ...
                >
                  ...
                  <div className="pack-info">
                    ...
                    <div className="pack-price">
                      <div className="price-original">VP {(pack.price != null ? Math.round(pack.price / 0.67).toFixed(2) : '0.00')}</div>
                      <div className="price-discounted">
                        VP {(() => {
            ...
            <div className="modal-body">
              ...
              <div className="preview-info">
                ...
                {(() => {
                  ...
                  const originalPrice = Math.round(basePrice / 0.67);
                  const discounted = Math.round(basePrice * (1 - (discountPercent > 0 ? discountPercent / 100 : 0)) / 0.67);
                  return (
